...
type FinanceData = {
  ...
  expenseReview: { expensesNeedingAttention: number; openFields: number; byField: Record<'classification' | 'vendor' | 'description' | 'date', number>; documented: number; refunded: number; total: number }
...
export default function FinancePage() {
  ...
  // The headline is expenses needing attention, not open fields: one expense
  // missing three things is one thing to sit down and answer, and the number
  // can never exceed the size of the book.
  const reviewFlags = data?.expenseReview.expensesNeedingAttention ?? 0
