...
export function HeroSection({ 
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute top-20 left-[15%] w-72 h-72 bg-gradient-to-br from-[#f97015]/25 to-[#f97015]/10 rounded-sm blur-3xl" />
      <div className="absolute bottom-10 right-[10%] w-96 h-96 bg-gradient-to-br from-[#f97015]/15 to-[#f97015]/5 rounded-sm blur-3xl" />
      
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
        <div className="max-w-4xl mx-auto text-center">
          {/* Glowing badge */}
          <div className="inline-flex items-center gap-2.5 px-5 py-2.5 mb-8 rounded-sm bg-[#f97015]/20 border border-[#f97015]/30 shadow-[0_0_30px_-5px_rgba(249,112,21,0.4)]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <div className="group flex items-center gap-3 px-6 py-3 rounded-sm bg-white/[0.07] backdrop-blur-xl border border-white/[0.15] text-sm text-white transition-all duration-300 hover:bg-white/[0.12] hover:border-[#f97015]/40 hover:shadow-[0_8px_30px_-5px_rgba(249,112,21,0.3)] hover:scale-105">
              <div className="w-8 h-8 rounded-sm bg-[#f97015] flex items-center justify-center group-hover:shadow-[#f97015]/50 transition-all">
